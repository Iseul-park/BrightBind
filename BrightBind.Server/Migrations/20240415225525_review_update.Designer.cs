...
namespace BrightBind.Server.Migrations
{
    ...
    [Migration("20240415225525_review_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrightBind.Server.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BrightBind.Server.Models.Goal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BrightBind.Server.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
